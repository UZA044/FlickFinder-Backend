...
public class Seeder {
	...
	public void createTables() {
		try {
			...
			stmt.execute("INSERT INTO movies (id, title, year) VALUES(6, 'Fast And Furious 7', 2008)");
			stmt.execute("INSERT INTO movies (id, title, year) VALUES(7, 'Dark Planet', 2008)");
			stmt.execute("INSERT INTO movies (id, title, year) VALUES(8, 'The Day The Earth Stood Still', 2008)");
			...
			stmt.execute("INSERT INTO ratings (movie_id, rating, votes) VALUES (6, 7.9, 150000)");
			stmt.execute("INSERT INTO ratings (movie_id, rating, votes) VALUES (7, 6.2, 50000)");
			stmt.execute("INSERT INTO ratings (movie_id, rating, votes) VALUES (8, 5.6, 2000)");
